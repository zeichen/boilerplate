...
RenderCustom.create = function(options) {
    var defaults = {
        controller: RenderCustom, element: null, canvas: null, options: {
            width: 800, height: 600, background: '#fafafa', wireframeBackground: '#222', hasBounds: false, enabled: true, wireframes: true, showSleeping: true, showDebug: false, showBroadphase: false, showBounds: false, showVelocity: false, showCollisions: false, showAxes: false, showPositions: false, showAngleIndicator: false, showIds: false, showShadows: false
        }
    };
    ...
    render.context = new PIXI.WebGLRenderer(render.options.width * 3, render.options.height, {
        view: render.canvas, transparent: transparent, antialias: true, backgroundColor: options.background
    });
    ...
    var pass1 = new PIXI.Text('Pass 1:\nHigh Constrast Render', {
        font: 'bold 12px Arial', fill: 0xffffff, stroke: 0x000000, strokeThickness: 2
    });
    pass1.x = 10;
    pass1.y = 10;
...
module.exports.ThresholdFilter=ThresholdFilter;
